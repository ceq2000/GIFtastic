$(document).ready(function() {
    ...
    var searchGifs = {
        searchTerms: ["cats", "basketball", "dogs", "cartoons", "jump", "fall", "fail", "cute", "babies", "cute", "prank"],
        createButtons: function() {
            for (var i = 0; i < searchGifs.searchTerms.length; i++) {
                var newBttn = $('<button>');
                newBttn.attr("data-search", searchGifs.searchTerms[i]);
                newBttn.attr("btn-secondary", searchGifs.searchTerms[i]);
                newBttn.addClass("btn btn-secondary btn-lg");
